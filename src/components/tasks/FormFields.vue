<template>
    <form class="w-full" @submit.prevent="handleSubmit">
        <div class="flex items-center gap-x-4 flex-wrap" >
            ...
            <button class="rounded-[1.1rem] lg:block hidden w-[120px] font-semibold bg-zinc-300 border-none h-12">Add Task</button> 
        </div>
        ...
        <button class="rounded-[1.1rem] mt-3 block lg:hidden w-full font-semibold bg-zinc-300 border-none h-12">Add Task</button> 
      </form>
</template>
<script setup>
